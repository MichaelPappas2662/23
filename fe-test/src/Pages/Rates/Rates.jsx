...
const Rates = () => {
  ...
  const fetchData = async () => {
    if (!loading) {
      ...
      await fetch(`https://rates.staging.api.paytron.com/rate/public?sellCurrency=${countryToCurrency[fromCurrency]}&buyCurrency=${countryToCurrency[toCurrency]}`, {
        method: 'GET',
        headers: {
      ...
      <div className={classes.content}>
        ...
        <div className={classes.rowWrapper}>
          ...
          <div className={classes.exchangeWrapper}>
            ...
            <Input className={classes.rowWrapper} label="Amount" type="number"  />
          </div>
